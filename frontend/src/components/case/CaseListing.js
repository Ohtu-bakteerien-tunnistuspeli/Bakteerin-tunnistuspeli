        ...
        <>
            {admin ?
                <tr>
                    ...
                    <td>
                        <Button variant='danger' style={{ float: 'right', margin: '2px' }} id='deleteCase' onClick={() => { if (window.confirm('Tahdotko varmasti poistaa tapauksen?')) { deleteCase(caseItem) } }}>Poista
